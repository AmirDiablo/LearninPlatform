        ...
        <div>
            ...
            <div>
                <ul className="bg-white fixed bottom-0 top-20 w-[50%] -left-[50%] dashboardNav transition-all duration-300 lg:left-[0%] lg:w-[30%] z-10">
                    ...
                    <Link to={role == "teacher" ? '/teacherdashboard/teacherQuizPage' : '/studentdashboard/studentQuizPage'}><li className={active == "teacherQuizPage" || active ==  "studentQuizPage"  ? "flex items-center gap-2 p-5 active" : "flex items-center gap-2 p-5"}><SiTestcafe />ًQuizes</li></Link>
